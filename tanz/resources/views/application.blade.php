...
<div class="row">
	<div class="col-lg-12">
		<div style=" margin:0 auto; background-color:#FFF;">
			<img src="text.png" style="width: 100%; max-width: 200px; padding: 15px;">
			...
			<div class="tab">
				<div class="tab-menu">
					<ul>
						<li>
							<a href="my_dashboard.aspx" class="active">Back to Dashboard</a>
						</li>
				...
				<div id="regForm">
					...
					<div class="tab1" style="display: block !important;">
						...
						<h2 style="text-align:left; margin-bottom:30px;">
							<span style="color:#28b24c;"> Applicant Details
								<br>Maelezo Binafsi</span>
						</h2>
						<div class="form-width">
							...
							<div class="row">
								...
								<div class="col-md-12 form-group">
									<label>Nationality
										<img src="{{asset('i.png')}}" title="(i) Unknown; born in any other country other than Tanzania and do not hold any nationality.">
										<br>Utaifa
...
(i)Registration - parent not born in Tanzania and holding Tanzanian passport" alt="(i) born in Tanzania\n(i) my parent was born in Tanzania\n(i) parent not born in Tanzania and holding Tanzanian passport">
										<br>Mimi naomba Uraia wa Tanzania kwa
										<img src="{{asset('i.png')}}" title="(i)Kuzaliwa -  nimezaliwa Tanzania
...
(i)Tajinisi - mzazi ambaye hajazaliwa Tanzania na kuwa na pasipoti ya Tanzania" alt="(i) born in Tanzania\n(i) my parent was born in Tanzania\n(i) parent not born in Tanzania and holding Tanzanian passport">
								...
								<div class="col-md-12 form-group">
									<h2 style="text-align:left; margin-bottom:30px;">
										<span style="color:#28b24c;"> Parent Details
											<br>Maelezo ya Mzazi</span>
									</h2>
									<h4 style="font-size:16px;">Please provide parent's details who is Tanzanian
										<br>Maelezo ya mzazi mtanzania</h4>
								</div>
								<div class="col-md-12 form-width">
									<div class="row">
										...
										<div id="ContentPlaceHolder1_UpdatePanel2" style="width:100%">
											...
											<div class="form-group col-md-12">
												<label>File number
													<img src="{{asset('i.png')}}" alt="the file number can be found on the last or 2nd last page of the parent's Tanzanian passport. The number is hand written."
														title="the file number can be found on the last or 2nd last page of the parent's Tanzanian passport. The number is hand written.">
													<br>namba ya faili
					...
					<div class="tab1" style="display: block !important">
						<h2 style="text-align:left; margin-bottom:30px;">
							<span style="color:#28b24c;"> Review &amp; Check Disclaimer</span>
						</h2>
						<h4>Applicant Details
							<br>Maelezo Binafsi</h4>
						...
						<div class="form-width">
							...
							<div class="form-width">
								<div class="row">
									<div class="form-group col-md-12">
										...
										<ul>
											<li>It must be noted that the grant or refusal of the Citizenship is at the sole
												discretion of the Minister of Home Affairs – Tanzania.</li>
											<li>It is the sole responsibility of the applicant of whoever is concerned to
												follow up with the Ministry of Home Affairs once the application/s are
												processed successfully by Immigration (Uhamiaji).</li>
											<li>Charges once received by Tanzanians Abroad are not refundable under any circumstances,
												irrespective of whether or not the application is accepted.</li>
											<li>The applicant or applying on behalf of, will be sole liable for any false,
												incorrect information or document provided to Immigration (Uhamiaji).</li>
											<li>You are required to sign on all (5) pages where applicable.</li>
											<li>You are required to print all the pages and attach with the below list of
												documents:</li>
										...
										<br> Note: all documents need to be in English or Kiswahili and colored copies
							...
							<div class="row">
								<div class="form-group col-md-12">
									<input id="ContentPlaceHolder1_CheckBox1" type="checkbox" name="agree"> I accept and agree on the
									<a href="term_and_conditions.aspx">Terms and Conditions</a>
								</div>
								<div class="form-group col-md-12">
									<input id="ContentPlaceHolder1_CheckBox2" type="checkbox" name="agree2">
									<label for="ContentPlaceHolder1_CheckBox2">I confirm that the information provided is correct; and will be held responsible
										and liable if incorrect.</label>
								</div>
							</div>
						</div>
					</div>
					<div style="overflow:auto;">
						<div style="float:right;padding-right:28px;padding-bottom:20px;">
							...
							<button onclick="__doPostBack('ctl00$ContentPlaceHolder1$btnsubscribe','')" id="ContentPlaceHolder1_btnsubscribe" class="btn btn-default"
								type="submit" style="float: right; display: none;">I accept and agree on all the above Terms.</button>
						</div>
					</div>
