                    ...
                    <div class="col-md-4">
                            <div class="form-group">
                                    ...
                                    <div class="dropdown country-of-birth" data="1">
                                            <button class="btn btn-secondary dropdown-toggle countryofbirth-hidden" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                              Dropdown button
                                            </button>
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
