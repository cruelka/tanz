...
<body>
    <form method="post" id="form1">
            ...
            <div class="modal-body" style="background-color: #fff; width: 100%; margin: 0 auto; padding: 5%;">
                <div id="UpdatePanel1" style="width:100%">
                    ...
                    <div>
                        ...
                        <p>
                            <button onclick="if (typeof(Page_ClientValidate) == 'function') Page_ClientValidate('blslog1'); __doPostBack('ctl00$btnsubscribe','')"
                                id="btnsubscribe" class="btn btn-primary" validationgroup="blslog1">Login</button>
        ...
        <div style="background-color:#FFF; position: fixed; z-index:10000000; width:100%; padding:50px; ">
            <div id="logo_home">
                <a href="/" title="Quote">
                    <img src="{{ asset('logo-sml.png') }}">
                </a>
            </div>

            <a id="menu-button-mobile" class="cmn-toggle-switch cmn-toggle-switch__htx">
            ...
            <nav class="main_nav">
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="http://www.immigration.go.tz/index.php/en/download/forms" target="_blank">Citizenship form</a>
                    </li>
                    <li>
                        <a href="">Status</a>
                    </li>
        ...
        <div id="additional_links1">
            <ul>
                ...
                <li>
                    <a href="/disclaimer" class="animated_link">Disclaimer</a>
                </li>
                <li>
                    <a href="/terms" class="animated_link">Term and conditions</a>
                </li>
            </ul>
        </div>
        <!-- /add links -->
